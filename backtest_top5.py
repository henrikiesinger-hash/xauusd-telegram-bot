...
# ==============================
# STRATEGY S1 — SMC Sniper (score >= 7.5, OB Midpoint, no Chop)
# ==============================

def strategy_s1_smc_sniper(data_m5, data_m15, data_h1,
...
STRATEGIES['S1_SMC_Sniper'] = strategy_s1_smc_sniper

# ==============================
# STRATEGY S2 — SMC + Candle Confirmation (score >= 6.0)
# ==============================

def strategy_s2_smc_candle_confirm(data_m5, data_m15, data_h1,
                                   candle_index, last_signal_idx,
                                   used_ob, last_result):
    score_threshold = 6.0
